...
<title><?php echo $titulo_hoja;?> - Tipos de Cobro</title>
...
// ===== Trae el tipo de cobro y llena el formulario =====
function devuelve_tipo_cobro(codigo)
    {
    global_codigo_seleccionado = codigo;
    marca_tipo_seleccionado();
    $("#id_espera").show();
    var url = "funciones_ajax.php?funcion=devuelve_tipo_cobro_dsft&parametro1=" + codigo;
...
function grabar_tipo_cobro()
    ...
    $("#id_espera").show();
    var url = "funciones_ajax.php?funcion=grabar_tipo_cobro_dsft"
    ...
    obj_ajax.success(function(data, status)
        ...
        if(data.substring(0, 2) == "OK")
            {
            messageBox("Tipo de cobro grabado correctamente");
            boton_nuevo();
            actualiza_listado();
            }
        else
...
function elimina_tipo_cobro(codigo)
    {
...
function ejecuta_eliminacion()
    ...
    $("#id_espera").show();
    var url = "funciones_ajax.php?funcion=elimina_tipo_cobro_dsft&parametro1=" + codigo + "&parametro2=" + global_codigo_usuario;
    var obj_ajax = $.get(url, function(data, status){;});
    obj_ajax.success(function(data, status)
        {
        $("#id_espera").hide();
...
function actualiza_listado()
    {
    $("#id_espera").show();
    var url = "funciones_ajax.php?funcion=lista_tipo_cobro_dsft&parametro1=" + global_ordenamiento + "&parametro2=" + global_direccion;
    var obj_ajax = $.get(url, function(data, status){;});
    obj_ajax.success(function(data, status)
        {
        $("#id_espera").hide();
...
<body class="metro">
    ...
    <div style="display: flex; flex-direction: row; align-items: flex-start; margin-top:10px; margin-left:0; gap: 8px;">
        ...
        <div id="id_panel_listado" class="aida" style="width: 760px; height: 850px; overflow: hidden; display: flex; flex-direction: column;">
            ...
            <span><center><strong><i class="icon-tag fg-darkRed"></i> TIPOS DE COBRO</strong></center></span>
        ...
        <div id="id_formulario_tipo" class="aida" style="width: 440px; height: auto;">
            <div class="ribbed-crimson" style="height: 2px;"></div>
            <span><center><strong><i class="icon-tag fg-darkRed"></i> DATOS DEL TIPO DE COBRO</strong></center></span>
            ...
            <div style="padding: 12px;">
                ...
                <div style="text-align: right; margin-top: 10px;">
                    <button type="button" class="button bg-darkRed bg-hover-red fg-white" onclick="grabar_tipo_cobro();">GRABAR</button>
    ...
    <div id="id_dialog_confirma" title="Confirmar eliminacion">Esta seguro de eliminar este tipo de cobro?</div>
