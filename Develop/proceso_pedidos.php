...
<html xmlns="http://www.w3.org/1999/xhtml">
   ...
   boton_nuevo();
    ...
    <body class="metro" onload="<?php echo $onload; ?>">
        ...
        <div class="documento" style="position:absolute;">
            <div class="pendientes">
                <div class="aida" style="width: 795px; margin-top: 25px; margin-left:10px;">
                    ...
                    <i class="icon-cart-2 fg-crimson" style="font-size: 25px"></i> PEDIDOS&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <i class="icon-filter fg-crimson" style="font-size: 20px"></i> 
                    <div class="input-control text" data-role="input-control text" style = "width: 60px; font-size:<?php echo $tamano_texto; ?>px;" onChange="carga_procesados(3);">
                        <input name="txtFechaDesde" id="txtFechaDesde" style = "font-size:<?php echo $tamano_texto; ?>px; height:25px" type="text" placeholder="PEDIDO" onkeypress="return ce_solo_numeros(event,this);" onblur="(isNaN(parseFloat(this.value))) ? this.value = 0 : this.value = parseFloat(this.value);"> 
                    ...
                    <div class="input-control text" data-role="input-control text" style = "width: 80px; font-size:<?php echo $tamano_texto; ?>px;" onChange="carga_procesados(3);">
                        <input name="txtFechaDesde" id="txtFechaDesde" style = "font-size:<?php echo $tamano_texto; ?>px; height:25px" type="text" placeholder="MARCACION"> 
                        <button class="btn-clear fg-crimson" tabindex="1" style = "top: 0px;"></button>
                    </div>                   
                    <div class="input-control checkbox margin10" data-role="input-control" style="">
                        <input type="checkbox" id="txtFiltroPagoS1" name="txtCerrados" onClick=""><span class="check"></span>Cerrados
                    </div>
                    <i class="icon-filter fg-crimson" style="font-size: 20px"></i>
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="text-left" style="<?php echo $estilo_tabla_aida; ?>">MARCACION</th>
                            <th class="text-left" style="<?php echo $estilo_tabla_aida; ?>">FECHA VUELO</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center" style="<?php echo $estilo_tabla_aida; ?>">1011</td>
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>">SCHOMANOV</td>
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>">RUTAFLOR</td>
                            ...
                            <td class="text-center" style="<?php echo $estilo_tabla_aida; ?>">
                                <a href="proceso_consolidados.php"><i title="CONSOLIDAR" class="icon-database fg-green"></i></a>
                                &nbsp;<a href="javascript: funcion2('1')"><i title="FACTURAR" class="icon-star-4 fg-yellow"></i></a>
                                &nbsp;<a href="javascript: funcion2('1')"><i title="APLICAR CREDITO" class="icon-alarm fg-crimson"></i></a>
                        ...
                        <tr>
                            <td class="text-center" style="<?php echo $estilo_tabla_aida; ?>"><i title="ABIERTO" class="icon-sun-3 fg-yellow"></i></td> 
                            <td class="text-center" style="<?php echo $estilo_tabla_aida; ?>">1012</td>
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>">DNDEX</td>
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>">DNDEX FLOR</td>
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>">2015-07-28</td>
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>">SIERRA CARGO</td>
                            <td class="text-center" style="<?php echo $estilo_tabla_aida; ?>">
                                <a href="javascript: funcion1('1')"><i title="CONSOLIDAR" class="icon-database fg-green"></i></a>
                                &nbsp;<a href="javascript: funcion2('1')"><i title="FACTURAR" class="icon-star-4 fg-yellow"></i></a>
                                &nbsp;<a href="javascript: funcion2('1')"><i title="APLICAR CREDITO" class="icon-alarm fg-crimson"></i></a>
                                &nbsp;&nbsp;<a href="javascript: funcion2('1')"><i title="EDITAR PEDIDO" class="icon-pencil fg-brown"></i></a>
                                <a href="javascript: funcion3('1')"><i title="ELIMINAR PEDIDO" class="icon-remove fg-red"></i></a>
        ...
        <div style="position:absolute;">
            <div class="aida" style="position:absolute; width: 430px; margin-top: 25px; margin-left:820px; height: <?php echo $lineas[$ultimo_indice]+85;?>px; ">
                <legend style="position: absolute; width: 400px;"><i class="icon-plus fg-crimson"></i> Ingreso de Pedidos</legend>
                <form name="frmPrincipal" target="_self">
                    <input type="hidden" name="txtCodigoPagoS" id="txtCodigoPagoS" value=""></input>
                    <fieldset style="position: absolute">
    <!--Linea 1-->
                        <label style="position: absolute; margin-top: <?php echo $lineas[1];?>px; width: 200px; "><i class="icon-cart-2 fg-crimson"></i> Pedido: </label>     
    ...
    <!-- Linea 10 --> 
                        <label style="position: absolute; margin-top: <?php echo $lineas[10];?>px; width: 240px;"><i class="icon-flickr fg-crimson"></i> Status: </label>
                        <div class="input-control radio default-style" data-role="input-control" style="position: absolute; width: 120px; margin-top: <?php echo $lineas[10];?>px; margin-left:110px;">
                        ...
                        <div class="input-control radio default-style" data-role="input-control" style="position: absolute; width: 150px; margin-top: <?php echo $lineas[10];?>px; margin-left:182px;">
                        ...
                        <div class="input-control radio default-style" data-role="input-control" style="position: absolute; width: 150px; margin-top: <?php echo $lineas[10];?>px; margin-left:280px;">
    ...
    <!-- Linea 11 --> 
                        <div>
                            <a href="javascript: boton_nuevo();" class="place-right button bg-darkRed bg-hover-red fg-white fg-hover-white bd-orange" style="position: absolute; margin-top: <?php echo $lineas[11];?>px; margin-left:240px;" tabindex="<?php echo $tabindex++;?>">Nuevo</a>
                            <a href="javascript: boton_ingresa_pago();" class="place-right button bg-darkRed bg-hover-red fg-white fg-hover-white bd-orange" style="position: absolute; margin-top: <?php echo $lineas[11];?>px; margin-left:315px;" tabindex="<?php echo $tabindex++;?>">Ingresar</a>
                        </div>
