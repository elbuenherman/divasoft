    ...
    <body class="metro" onload="<?php echo $onload; ?>">
        ...
        <div class="documento" style="position:absolute;">
            <div class="pendientes">
                <div class="aida" style="width: 1150px; margin-top: 25px; margin-left:10px;">
                    <div class="ribbed-crimson" style="height: 2px;"></div>            
                    <i class="icon-attachment fg-crimson" style="font-size: 25px"></i> FINCAS
<!--FILTROS--> 
<!--1ERA LINEA DE FILTROS-->
                        <div class="input-control radio default-style" data-role="input-control" style="width: 75px; margin-top: 10px; margin-left:20px;">
                            <label><input type="radio" tabindex="<?php echo $tabindex++;?>" id="txtTpoPagoS1" name="txtTpoPagoS" value = "1" checked /><span class="check"></span>Todas
                                <!--<i title="Sin crédito" class="icon-sun-3 fg-yellow"></i>-->
                            </label>
                        </div>
                        <div class="input-control radio default-style" data-role="input-control" style="width: 80px; margin-top: 10px; margin-left:0px;">
                            <label><input type="radio" tabindex="<?php echo $tabindex++;?>" id="txtTpoPagoS2" name="txtTpoPagoS" value = "2" /><span class="check"></span>A favor</label>
                        </div> 
                        <div class="input-control radio default-style" data-role="input-control" style="width: 100px; margin-top: 10px; margin-left:0px;">
                            <label><input type="radio" tabindex="<?php echo $tabindex++;?>" id="txtTpoPagoS2" name="txtTpoPagoS" value = "2" /><span class="check"></span>En contra</label>
                        </div>      
                    <div class="input-control text" style = "width: 120px; margin-top: 0px; margin-left:250px; font-size:<?php echo $tamano_texto; ?>px;" data-role="datepicker" data-format="yyyy-mm-dd" data-position="bottom" onChange="carga_procesados(3);">
                    ...
                    <div class="input-control text" style = "width: 120px; margin-top: -15px; margin-left:0px; font-size:<?php echo $tamano_texto; ?>px;" data-role="datepicker" data-format="yyyy-mm-dd" data-position="bottom">
                    ...
                    <div class="input-control text" data-role="input-control text" style = "width: 100px; font-size:<?php echo $tamano_texto; ?>px;" onChange="carga_procesados(3);">
                        <input name="txtFechaDesde" id="txtFechaDesde" style = "font-size:<?php echo $tamano_texto; ?>px; height:25px" type="text" placeholder="FACTURA"> 
                        <button class="btn-clear fg-crimson" tabindex="1" style = "top: 0px;"></button>
                    </div>   
...
<!--FIN DE FILTROS-->                        
                    ...
                    <thead>
                        <tr>
                            <th class="text-center" style="<?php echo $estilo_tabla_aida; ?>">Fecha</th> 
                            <th class="text-center" style="<?php echo $estilo_tabla_aida; ?>">Factura</th>
                            <th class="text-left" style="<?php echo $estilo_tabla_aida; ?>">Finca</th>
                            <th class="text-left" style="<?php echo $estilo_tabla_aida; ?>">FB</th>
                            <th class="text-left" style="<?php echo $estilo_tabla_aida; ?>">Tallos</th>
                            <th class="text-left" style="<?php echo $estilo_tabla_aida; ?>">Valor</th>    
                            <th class="text-left" style="<?php echo $estilo_tabla_aida; ?>">Marcación</th>  
                            <th class="text-left" style="<?php echo $estilo_tabla_aida; ?>">Invoice</th>   
                            <th class="text-left" style="<?php echo $estilo_tabla_aida; ?>">Fecha Pago</th>    
                            <th class="text-left" style="<?php echo $estilo_tabla_aida; ?>">No. Pago</th>   
                            <th class="text-left" style="<?php echo $estilo_tabla_aida; ?>">Tipo Pago</th>           
                            <th class="text-left" style="<?php echo $estilo_tabla_aida; ?>">Banco</th>  
                            <th class="text-left" style="<?php echo $estilo_tabla_aida; ?>">Total</th>  
                            <th class="text-center" style="<?php echo $estilo_tabla_aida; ?>">Opciones</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td class="text-center" style="<?php echo $estilo_tabla_aida; ?>">14/07/2015</td> 
                            <td class="text-center" style="<?php echo $estilo_tabla_aida; ?>">101118583</td>
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>">ALEXANDRA FLOWERS</td>
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>">0.5</td>
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>">300</td>
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>">$150.00</td>
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>">RENOIR</td>
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>">10019</td>   
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>">14/07/2015</td>
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>">2011</td>
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>">Cheque</td>      
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>">Pichincha</td>  
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>"><strong>$0.00</strong></td>
                            <td class="text-center" style="<?php echo $estilo_tabla_aida; ?>">
                                <a href="javascript: funcion2('1')"><i title="Recibo pago" class="icon-newspaper fg-blue"></i></a>
                                <a href="javascript: funcion2('1')"><i title="Observaciones Pago" class="icon-clipboard-2 fg-crimson"></i></a>
                            </td>      
                        </tr> 
                        <tr>
                            <td class="text-center" style="<?php echo $estilo_tabla_aida; ?>">4/08/2015</td> 
                            <td class="text-center" style="<?php echo $estilo_tabla_aida; ?>">8263</td>
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>">ALEXANDRA FLOWERS</td>
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>">0.25</td>
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>">150</td>
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>">$49.00</td>
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>">TROYA</td>
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>">10015</td>   
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>">4/08/2015</td>
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>">2008</td>
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>">TRANSFERENCIA</td>      
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>">Produbanco</td>    
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>"><strong>$10.00</strong></td>
                            <td class="text-center" style="<?php echo $estilo_tabla_aida; ?>">
                                <a href="javascript: funcion2('1')"><i title="Recibo pago" class="icon-newspaper fg-blue"></i></a>
                                <a href="javascript: funcion2('1')"><i title="Observaciones Pago" class="icon-clipboard-2 fg-crimson"></i></a>
                            </td>      
                        ...
                        <tr>
                            ...
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>">Cheque</td>      
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>">Pichincha</td> 
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>"><strong>$20.00</strong></td>
                            <td class="text-center" style="<?php echo $estilo_tabla_aida; ?>">
                                <a href="javascript: funcion2('1')"><i title="Recibo pago" class="icon-newspaper fg-blue"></i></a>
                                <a href="javascript: funcion2('1')"><i title="Observaciones Pago" class="icon-clipboard-2 fg-crimson"></i></a>
                            </td>      
                        ...
                        <tr>
                            ...
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>">Cheque</td>      
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>">Pichincha</td>        
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>"><strong>$30.00</strong></td>
                            <td class="text-center" style="<?php echo $estilo_tabla_aida; ?>">
                                <a href="javascript: funcion2('1')"><i title="Recibo pago" class="icon-newspaper fg-blue"></i></a>
                                <a href="javascript: funcion2('1')"><i title="Observaciones Pago" class="icon-clipboard-2 fg-crimson"></i></a>
                            </td>      
                        ...
                        <tr>
                            ...
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>">Cheque</td>      
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>">Pichincha</td>
                            <td class="text-left" style="<?php echo $estilo_tabla_aida; ?>"><strong>$40.00</strong></td>
                            <td class="text-center" style="<?php echo $estilo_tabla_aida; ?>">
                                <a href="javascript: funcion2('1')"><i title="Recibo pago" class="icon-newspaper fg-blue"></i></a>
                                <a href="javascript: funcion2('1')"><i title="Observaciones Pago" class="icon-clipboard-2 fg-crimson"></i></a>
                            </td>      
